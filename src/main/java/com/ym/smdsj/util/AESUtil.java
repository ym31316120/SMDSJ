...
public class AESUtil {
    ...
    private static final String ENCODE_RULES = "abcde12345fgh123";
    ...
    public static String aesEncode(String content, String encryptKey) {
        try {
            ...
            cipher.init(Cipher.ENCRYPT_MODE, keySpec, new IvParameterSpec(encryptKey.getBytes("utf-8")));
